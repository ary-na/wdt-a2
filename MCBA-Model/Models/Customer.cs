...
public class Customer
{
    ...
    [StringLength(11),
     RegularExpression(@"^[1-9]{3}\s[1-9]{3}\s[1-9]{3}$", ErrorMessage = "TFN must be of the format: XXX XXX XXX.")]
    ...
    [MaxLength(3),
     RegularExpression(@"^[A-Z,a-z]{2,3}$", ErrorMessage = "State must be a 2 or 3 lettered Australian state.")]
    ...
    [StringLength(12),
     RegularExpression(@"^04[0-9]{2}\s[0-9]{3}\s[0-9]{3}$",
         ErrorMessage = "Mobile must be of the format: 04XX XXX XXX.")]
