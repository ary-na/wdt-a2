...
public class Transaction
{
    ...
    [DisplayName("Transaction ID")] public int TransactionID { get; set; }

    [DisplayName("Transaction Type")] public TransactionType TransactionType { get; set; }

    [ForeignKey(nameof(Account)), DisplayName("Account Number")]
    ...
    [DisplayName("Transaction Time")] public DateTime TransactionTimeUtc { get; set; }
}